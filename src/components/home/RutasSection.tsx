    ...
    <section id="rutas" className="py-16 md:py-24 bg-jade-dark text-primary-foreground relative">
      ...
      <div className="container mx-auto px-4 relative z-10">
            ...
            >
              ...
              >
                <div className="flex-1">
                  <h3 className="font-heading text-lg md:text-xl font-semibold flex items-center gap-2">
                    <span>{route.origin}</span>
                    <ArrowRight size={16} />
                    <span>{route.destination}</span>
                  </h3>
                  {route.badge && (
                    <p className="mt-1 text-sm text-primary-foreground/60">{route.badge}</p>
                  )}
                </div>
                ...
                <div className="flex items-center gap-6 mt-3 md:mt-0">
                  <div className="text-center">
                    ...
                    <p className="font-semibold text-gold">{route.duration}</p>
                  </div>
                  <div className="text-center">
        ...
        <div className="text-center mt-8">
          <Link to="/tren-maya" className="inline-flex items-center gap-2 text-sm font-medium text-gold hover:text-gold-light transition-colors underline underline-offset-4">
            Ver todas las rutas <ArrowRight size={14} />
          </Link>
        </div>
      </div>
    </section>
